...
function Canta() {
    ...
    const categories = ['Omuz', 'Sırt', 'Postacı', 'El', 'Portföy'];
    ...
    return (
        <div style={{position:'relative'}}>
            <div style={{marginBottom: '24px'}}>
                <div style={{fontSize: '15px', color: '#444', marginBottom: '8px'}}>ANASAYFA &gt; ÇANTA</div>
                <h2 className="baslik" style={{textAlign:'center', fontWeight:'bold', fontSize:'48px'}}>ÇANTA MODELLERİ</h2>
            </div>
...
// Açıklama: Filtre menüsü soldan açılır panel olarak düzenlendi. Her bir filtre kategorisi (fiyat, kategori, renk, materyal) için ayrı açılır menüler eklendi.